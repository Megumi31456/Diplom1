  ...
  return (
    <div className="max-w-3xl">
      ...
      <form action={createPostAction} className="card mt-8 space-y-4">
        ...
        <input className="input" name="media_url" placeholder="Ссылка на изображение / видео / материал" />
        ...
        <div className="flex flex-wrap gap-3">
          <button name="status" value="pending" className="btn-primary">Отправить на модерацию</button>
